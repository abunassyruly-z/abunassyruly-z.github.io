...
Converter Integrated Circuit. The project focuses on the 
...
To determine the required component values for the feed-
back network, a mathematical model was established based
on the LT1376’s internal reference voltage (Vre f ≈ 2.42 V).
